...
@onready var body_visual: Panel = $BodyVisual
@onready var eyes: Node2D = $BodyVisual/Eyes
...
func _set_stand_shape() -> void:
	...
	body_visual.size = Vector2(64, STAND_HEIGHT)
	body_visual.position = Vector2(-32, -STAND_HEIGHT)
	eyes.position = Vector2(32, 28)
...
func _set_slide_shape() -> void:
	...
	body_visual.size = Vector2(64, SLIDE_HEIGHT)
	body_visual.position = Vector2(-32, -SLIDE_HEIGHT)
	eyes.position = Vector2(32, 16)
